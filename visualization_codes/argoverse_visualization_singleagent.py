from ArgoverseDataset.visualization import Visualizer
...
def test(args):
    ...
    folder_name = 'argoverse_' + args.model_name + '_model' + str(args.exp_id)
    ...
    for current_frame_idx in range(args.start_frm_idx, args.end_frm_idx):
        ...
        for a in range(num_agents):
            ...
            fig, ax = vs.topview_pc()

            # draw hdmap
            scene_location = scene.city_name
            ax = vs.topview_hdmap(ax, scene.agent_dict['EGO'], scene_location)
