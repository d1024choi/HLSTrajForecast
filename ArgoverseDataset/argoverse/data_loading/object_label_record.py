...
from ArgoverseDataset.argoverse.utils.cv2_plotting_utils import add_text_cv2, draw_clipped_line_segment
from ArgoverseDataset.argoverse.utils.se3 import SE3
from ArgoverseDataset.argoverse.utils.transform import quat2rotmat
from ArgoverseDataset.argoverse.visualization.vis_mask import vis_mask
...
class ObjectLabelRecord:
    ...
    def render_clip_frustum_cv2(
        ...
        # debug : bottom line indicating direction
