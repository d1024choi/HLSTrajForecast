...
from NuscenesDataset.nuscenes.prediction.helper import quaternion_yaw
from NuscenesDataset.nuscenes.prediction.input_representation.interface import AgentRepresentation
from NuscenesDataset.nuscenes.prediction.input_representation.utils import convert_to_pixel_coords, get_crops, get_rotation_matrix
...
class AgentBoxesWithFadedHistory(AgentRepresentation):
    ...
    def make_representation_(self, ann_token: str, sample_token: str) -> np.ndarray:
        ...
        center_agent_annotation = self.helper.data.get('sample_annotation', ann_token)
