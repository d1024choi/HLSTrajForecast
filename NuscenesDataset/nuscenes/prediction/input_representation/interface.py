...
class InputRepresentation:
    ...
    def make_input_representation_(self, ann_token, sample_token):

        static_layers = self.static_layer_rasterizer.make_representation_(ann_token, sample_token)
        agents = self.agent_rasterizer.make_representation_(ann_token, sample_token)
